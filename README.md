This app can be used for chatting with the users who are registered in this app. This app only supports of texts only. Users must sign up first and use the app.
